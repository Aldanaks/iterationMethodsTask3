...
******************************************************************/
const Task1 = temperatures.filter((Task1) => {
  if (Task1 >= 25) {
    return true;
  } else {
    return false;
...
const Task2 = temperatures.filter((Task2) => {
  if (Task2 < 20) {
    return true;
  } else {
    return false;
...
const Fahrenheit = temperatures.map((task3) => {
  return (task3 * 9) / 5 + 32;
});

console.log("Output 3", Fahrenheit);

const replace = temperatures.map((task4) => {
  if (task4 >= 25) return (task4 = "warm");
  else if (task4 >= 20 && task4 <= 24) return (task4 = "Mild");
  else return (task4 = "cool");
});

console.log("output 4", replace);
/*****************************************************************
...
console.log("Highest temperature of the month:", highest);

const lowest = Math.min(...temperatures);
console.log("Highest temperature of the month:", lowest);
